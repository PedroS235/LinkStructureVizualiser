...
class Graph():
    ...
    def createEdgeWAttr(self):
        ...
        self.G.add_edge(self.edges[0][0], self.edges[0][1], r=r, g=g, b=b)
        for e in range(1, len(self.edges)-1):
            if e == len(self.edges)-2:
                if prev_edge != self.edges[e+1][0]:
                    if g>=0.2:
                        ...
                        g = 0.5
                        b=0.5
                self.G.add_edge(self.edges[e+1][0], self.edges[1+1][1], r=r, g=g, b=b)
            else:
